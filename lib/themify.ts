...
const themeList: Record<string, Record<string, any>> = {}

const convertToDatauri = (path: string) => {
...
export default ({ count, theme = 'moebooru', length = 7 }: { count: number | string, theme: string, length: number }) => {
